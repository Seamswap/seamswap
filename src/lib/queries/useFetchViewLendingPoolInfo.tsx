...
import { useFetchRawReservesData } from '@src/lib/queries/useFetchRawReservesData';
import { aaveOracleAbi, aaveOracleAddress } from '@src/lib/config/contract';
import { assetsConfig } from '@src/lib/config/config';
import { useFetchCoinGeckoPricesByAddress } from '@src/lib/queries/useFetchCoinGeckoPrice';
import { mergeQueryStates } from '@src/lib/formatters/mergeQueryStates';
import { fUsdValueStructured } from '@src/lib/formatters/getFetchBigIntFormatted';
